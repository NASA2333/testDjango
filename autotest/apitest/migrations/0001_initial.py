# Generated by Django 2.0.3 on 2018-09-28 04:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('apitestname', models.CharField(max_length=64, verbose_name='接口名称')),
                ('apitestdesc', models.CharField(max_length=200, null=True, verbose_name='接口描述')),
